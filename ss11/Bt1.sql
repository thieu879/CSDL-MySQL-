...
select 
    ...
    Branch.Location
from Employees
join Branch on Branch.BranchID = Employees.BranchID;
...
create view employeebranch as
select employeeid, fullname, branch, phonenumber
from employees;

delete from employeebranch where branch = 'Chi nhánh Hà Nội';
